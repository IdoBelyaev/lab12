...
public class FamilyTree {
    ...
    private void addLine(String line) throws TreeException
    {
        ...
        if (colonIndex < 0)
            throw new TreeException("Line does not contain colon: " + line);
        ...
        if (root == null) {
            ...
            if (parentNode == null)
                throw new TreeException("Parent not found in tree: " + parent);
        }
    ...
    TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException {
        ...
        for (TreeNode ancestor : ancestorsOf1) {
            if (ancestorsOf2.contains(ancestor))
                return ancestor;
        }
